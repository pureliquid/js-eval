...
var fetchInput = function (doOnFetch) { return __awaiter(void 0, void 0, void 0, function () {
    var res;
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                res = _a.sent();
                return [4 /*yield*/, doOnFetch(res)];
            case 2:
                _a.sent();
                return [4 /*yield*/, fetchInput(doOnFetch)];
            case 3:
                _a.sent();
                return [2 /*return*/];
        }
...
var wss = new _WebSocket.Server({ port: 8080 });
var startWsServer = function () { return __awaiter(void 0, void 0, void 0, function () {
    return __generator(this, function (_a) {
        console.log('startup...');
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, fetchInput(function (d) { return __awaiter(void 0, void 0, void 0, function () {
                                return __generator(this, function (_a) {
                                    ws.send(d);
                                    return [2 /*return*/];
                                });
