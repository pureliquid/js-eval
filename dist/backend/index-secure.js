...
var saveTo = '';
var handleQuery = function (query, ws) {
...
wsServer.on('request', function (request) {
                ...
                switch (_b.label) {
                    case 0:
                        ...
                        try {
                            ...
                            console.log((_a = JSON.parse(message)) === null || _a === void 0 ? void 0 : _a.response);
                        }
                        return [4 /*yield*/, prompt('> ')];
                    case 1:
                        query = _b.sent();
                        return [4 /*yield*/, handleQuery(query, connection)];
                    case 2:
                        _b.sent();
                        return [2 /*return*/];
                }
    ...
    connection.on('close', function (reasonCode, description) {
        ...
        console.log("ReasonCoder: ".concat(reasonCode, " "), description);
    });
});
